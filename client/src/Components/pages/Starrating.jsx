            ...
            <div className=' bg-white py-2  border-2 rounded-lg w-[26%] mx-auto '>
                <form action="" onSubmit={sendmsg}>
                    ...
                    <div className='text-center '>
                        ...
                        <textarea name="" id="" rows={3} className='w-[85%]  border-black rounded-md' onChange={inputHandler}></textarea>
                    </div>
                    <div className='flex justify-center gap-4'>
                        <button className='bg-black text-[#fff] py-[2px] px-3  rounded-lg'>Not Now</button>
                        <button className='bg-[#00B2FF] text-[#fff] py-[2px] px-4 rounded-lg' type='submit'>Submit</button>
                    </div>
