...
export const SubscriberBiodata1 = () => {
  return (
    ...
    <ul className='flex flex-col gap-10 pt-[80px]  lg:text-[17px] md:text-[13px] sm:text-[10px]'>
            ...
            <Link to="/totalsubscriber" className="    py-1 rounded-full ">
            ...
            <Link to="/totalcustomers" className="py-1 hover:bg-[#0091CF] rounded-full font-bold ">
