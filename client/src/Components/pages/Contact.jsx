            ...
            <div className="max-w-[95%] mx-auto sm:py-4 my-4">
              <form onSubmit={formHandler}>
                <div className="grid xs:grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block m:text-mp xs:text-tp md:text-p text-[#000] font-[600]" htmlFor="cn">Contact No.</label>
                  ...
                  <div>
                    <label className="block m:text-mp xs:text-tp md:text-p text-[#000] font-[600]" htmlFor="help">How we can help you</label>
